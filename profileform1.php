...
<body>
  <div class="container" id="page1">
    ...
    <div class="form-group">
      ...
      <button type="button" class="btn btn-primary" onclick="nextPage('page1', 'page2')">Next</button>
    </form>
  </div>
...
<div id="experience_error" class="error"></div>
      ...
      <button type="button" class="btn btn-primary next-button" onclick="nextPage('page2', 'page3')">Next</button>
    </form>
  </div>
